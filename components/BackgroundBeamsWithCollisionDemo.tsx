  ...
  return (
    <BackgroundBeamsWithCollision>
      <div className="flex flex-col items-center justify-center h-full px-4 md:px-8 lg:px-12">
        ...
        <div className="relative mx-auto inline-block w-full max-w-3xl mt-2 sm:mt-6 md:mt-8 lg:mt-4 [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
          <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r py-4 from-purple-500 via-violet-500 to-pink-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">
            <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl block text-center font-light">
        ...
        <button className="p-[3px] relative mt-3 sm:mt-8 md:mt-10 lg:mt-12">
